...
const CreateRoom: React.FC = () => {
  ...
  const [username] = useState(user?.name || sessionStorage.getItem('username') || '');
            ...
            <div style={styles.infoItem}>
              ...
              <div style={styles.userSelector}>
                <button 
                  ...
                  onClick={() => setMaxUsers(Math.max(2, maxUsers - 1))}
                  disabled={maxUsers <= 2}
                >
                  -
                </button>
                <span style={styles.infoText}>{maxUsers}명</span>
                <button 
                  style={styles.userButton}
                  onClick={() => setMaxUsers(Math.min(8, maxUsers + 1))}
                  disabled={maxUsers >= 8}
                >
                  +
                </button>
