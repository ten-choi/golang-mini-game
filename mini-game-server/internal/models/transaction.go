...
type RewardTransaction struct {
	GameRoomID string `json:"gameRoomId,omitempty" bson:"game_room_id,omitempty"`
	GameType   string `json:"gameType,omitempty" bson:"game_type,omitempty"`
	Rank       int    `json:"rank,omitempty" bson:"rank,omitempty"`
	IsWinner   bool   `json:"isWinner,omitempty" bson:"is_winner,omitempty"`
}
