                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "result": {
                                            "$ref": "#/definitions/models.GameRoom"
                                        }
                                    }
                                }
                            ]
        ...
        "/game/room/{id}": {
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Action to perform (e.g., 'advance_round')",
                        "name": "action",
                        "in": "formData"
                    },
                    {
        ...
        "/game/room/{id}/join": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Username of the player joining",
                        "name": "ldap_user",
                        "in": "formData",
                        "required": true
                    }
