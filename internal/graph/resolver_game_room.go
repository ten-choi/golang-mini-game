...
func (r *mutationResolver) CreateGameRoom(ctx context.Context, input model.CreateGameRoomInput) (*model.GameRoom, error) {
	...
	room.Users = append(room.Users, &model.GameUser{
		...
		Name:    "", // TODO: Fetch username from user service
		Score:   0,
		IsReady: true,
	})
...
func (r *subscriptionResolver) UserConnectionStatus(ctx context.Context, roomID string) (<-chan *model.PlayerConnection, error) {
	// TODO: Implement user connection status subscription
